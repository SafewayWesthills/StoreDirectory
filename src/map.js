...
jvm.Map.prototype = {
  ...
  bindZoomButtons: function() {
    ...
    jvm.$('<div/>').addClass('jvectormap-zoomin').html('<i class="bi bi-plus-square"></i>').appendTo(this.container);
    jvm.$('<div/>').addClass('jvectormap-zoomout').html('<i class="bi bi-dash-square"></i>').appendTo(this.container);
